...
var _require = require('../email/account'),
    ...
    sendCancelMail = _require.sendCancelMail;
...
router.get('/user/:id', function _callee7(req, res) {
  var userOne;
...
router.post('/user/login', function _callee8(req, res) {
  var userOne, token;
...
router.post('/user/logout', auth, function _callee9(req, res) {
...
router.post('/user/logoutall', auth, function _callee10(req, res) {
...
router.patch('/user/me', auth, function _callee11(req, res) {
...
router["delete"]('/user/me', auth, function _callee12(req, res) {
